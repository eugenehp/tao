...
/// Additional methods on [`EventLoop`] that are specific to visionOS.
pub trait EventLoopExtVisionOS {
  /// Returns the [`Idiom`] (phone/tablet/tv/etc) for the current device.
  fn idiom(&self) -> Idiom;
}

impl<T: 'static> EventLoopExtVisionOS for EventLoop<T> {
  fn idiom(&self) -> Idiom {
    self.event_loop.idiom()
  }
}

/// Additional methods on [`Window`] that are specific to visionOS.
pub trait WindowExtVisionOS {
...
impl WindowExtVisionOS for Window {
  #[inline]
  fn ui_window(&self) -> *mut c_void {
...
/// Additional methods on [`WindowBuilder`] that are specific to visionOS.
pub trait WindowBuilderExtVisionOS {
...
impl WindowBuilderExtVisionOS for WindowBuilder {
  #[inline]
...
/// Additional methods on [`MonitorHandle`] that are specific to visionOS.
pub trait MonitorHandleExtVisionOS {
...
impl MonitorHandleExtVisionOS for MonitorHandle {
  #[inline]
  fn ui_screen(&self) -> *mut c_void {
